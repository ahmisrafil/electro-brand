...
const Home = () => {
    ...
    return (
        <div>
            ...
            <Founders></Founders>
            <footer className="footer footer-center p-10 bg-[#060d5e] text-primary-content">
                <aside>
                    <img className="inline-block fill-current h-[50px]" src="https://i.ibb.co/bJS031m/electro-logo.png" alt="" />
                    <p className="font-bold">
                        Electro Ltd. <br />Online Gadget Shop since 2010
                    </p>
